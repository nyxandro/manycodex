...
Авторизация OpenCode для провайдеров хранится глобально (в профиле пользователя), поэтому этот плагин рассчитан на глобальную установку.

1) Скопируйте файлы:

- `plugins/openai-multi.ts` -> `~/.config/opencode/plugins/openai-multi.ts`
- `commands/oai.md` -> `~/.config/opencode/commands/oai.md`
